<h2><a href="https://www.geeksforgeeks.org/problems/nth-fibonacci-number-using-bigintegers/1">Nth Fibonacci number using BigIntegers</a></h2><h3>Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given one integer <strong>n</strong>. Your task is to find nth fibonacci number. You have to return value of nth fibonacci number in <strong>BigInteger</strong>. </span></p>
<blockquote>
